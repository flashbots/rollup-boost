## Contributing to rollup-boost

Welcome to the Flashbots collective!

Thanks for your help improving `rollup-boost`! We are so happy to have you! We just ask you to be nice when you play with us.
...
For any questions or concerns that are not covered in the documentation, please open a [GitHub issue](https://github.com/flashbots/rollup-boost/issues).
...
1. **By opening an issue:** For example, if you believe that you have uncovered a bug
   in `rollup-boost`, creating a new issue in the issue tracker is the way to report it.
...
- Every pull request should include one or more tests to ensure that rollup-boost does not regress in the future.
...
The `rollup-boost` project adheres to the [Rust Code of Conduct](https://github.com/rust-lang/rust/blob/master/CODE_OF_CONDUCT.md). This code of conduct describes the _minimum_ behavior
expected from all contributors.

Instances of violations of the Code of Conduct can be reported by contacting the team
at [rollup-boost@flashbots.net](mailto:rollup-boost@flashbots.net).
